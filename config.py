...
SKEMA_THUMBNAIL = {
    "merah_emas": {
        "Naik": {
            ...
            "hl_teks": (255,255,255), "icon": "▲ NAIK",
            "bg_grad_atas": (60,0,0),
        },
        "Turun": {
            "badge": (0,140,50), "aksen": (0,230,80),
            "teks": (180,255,160), "sub": (200,255,200),
            "hl_teks": (255,255,255), "icon": "▼ TURUN",
            "bg_grad_atas": (0,40,10),
        },
        "Stabil": {
            "badge": (140,100,0), "aksen": (255,190,0),
            "teks": (255,230,100), "sub": (255,240,180),
            "hl_teks": (255,255,255), "icon": "= STABIL",
    ...
    "biru_perak": {
        ...
        "Turun": {
            "badge": (0,120,160), "aksen": (0,220,200),
            "teks": (180,255,250), "sub": (200,255,255),
            "hl_teks": (255,255,255), "icon": "▼ TURUN",
    ...
    "hijau_platinum": {
        "Naik": {
            ...
            "hl_teks": (0,50,0), "icon": "▲ NAIK",
            "bg_grad_atas": (0,40,15),
        },
        "Turun": {
            "badge": (180,140,0), "aksen": (255,210,0),
            "teks": (255,240,150), "sub": (255,245,180),
            "hl_teks": (50,30,0), "icon": "▼ TURUN",
            "bg_grad_atas": (50,40,0),
        },
        "Stabil": {
            "badge": (60,120,60), "aksen": (150,255,150),
            "teks": (220,255,220), "sub": (230,255,230),
            "hl_teks": (0,50,0), "icon": "= STABIL",
    ...
    "ungu_mewah": {
        ...
        "Turun": {
            "badge": (80,0,140), "aksen": (180,100,255),
            "teks": (230,200,255), "sub": (240,220,255),
            "hl_teks": (255,255,255), "icon": "▼ TURUN",
    ...
    "oranye_tembaga": {
        "Naik": {
            ...
            "hl_teks": (50,20,0), "icon": "▲ NAIK",
            "bg_grad_atas": (60,25,0),
        },
        "Turun": {
            "badge": (160,60,0), "aksen": (255,100,0),
            "teks": (255,180,100), "sub": (255,200,150),
            "hl_teks": (50,15,0), "icon": "▼ TURUN",
            "bg_grad_atas": (50,20,0),
        },
        "Stabil": {
            "badge": (180,100,0), "aksen": (255,160,50),
            "teks": (255,220,150), "sub": (255,235,180),
            "hl_teks": (50,25,0), "icon": "= STABIL",
